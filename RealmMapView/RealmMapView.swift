...
open class RealmMapView: MKMapView {
    ...
    @IBInspectable open var clusterAnnotations: Bool = true

    /// Designates if the map view automatically refreshes when the map moves
    @IBInspectable open var autoRefresh: Bool = true
    ...
    @IBInspectable open var zoomOnFirstRefresh: Bool = true

    /// If enabled, annotation views will be animated when added to the map.
    ///
    /// Default is YES
    @IBInspectable open var animateAnnotations: Bool = true

    /// If YES, a standard callout bubble will be shown when the annotation is selected.
    /// The annotation must have a title for the callout to be shown.
    @IBInspectable open var canShowCallout: Bool = true
